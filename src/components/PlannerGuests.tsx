    ...
    <div className="space-y-8 pb-12" id="planner-guests-root">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4" id="guests-stats-dashboard">
        ...
        <div className="bg-stone-900 border border-stone-800 text-white p-5 rounded-2xl shadow-sm text-left flex items-center gap-4 relative overflow-hidden">
          ...
          <div className="z-10">
            <span className="text-[10px] text-stone-300 font-semibold block">Expected Headcount Peak</span>
            <h3 className="text-2xl font-semibold leading-none mt-1">
              {peakExpectedHeadcount}
            </h3>
            <span className="text-[9px] text-stone-400 font-mono italic mt-1 block">
