...
export const Footer: React.FC<{ isDarkMode: boolean; onNavigate?: (page: string) => void }> = ({ isDarkMode, onNavigate }) => {
  ...
  return (
    <>
      {/* 20px Traditional Mithila/Madhubani Folk-Art Strip Border */}
      <div 
        ...
        <div className="footer-download-banner-inner mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 pt-12 md:pt-16 pb-0">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-end md:items-stretch">
            <div className="space-y-4 pb-12 md:pb-16">
              ...
              >
                Download the {APP_NAME} app today!
              </h3>
              <div className="text-orange-50 text-base max-w-md space-y-4">
                ...
                <div className="pt-2">
                  <p className="tagline py-2 bg-white/10 px-4 py-2 rounded-xl backdrop-blur-sm border border-white/5 inline-block text-xs md:text-sm">
                    <strong>Ghar ka bada function? Ab notebook nahi, {APP_NAME} use karo 😄</strong>
                  </p>
                </div>
              </div>
            ...
            <div className="footer-download-phone flex h-full w-full items-end justify-center md:justify-end">
              <AppPhoneMockup variant="device" className="w-full" />
            </div>
          </div>
        </div>
      </section>
