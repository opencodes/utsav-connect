  ...
  return (
    ...
    >
      <div className="relative w-full sm:w-48 h-44 sm:h-auto sm:self-stretch shrink-0 overflow-hidden bg-stone-100">
        ...
        />
        {vendor.offerText && (
          <div className="absolute bottom-2 left-2 bg-gradient-to-r from-red-600 to-orange-500 text-white font-bold text-[10px] px-2 py-1 rounded shadow line-clamp-2 max-w-[90%]">
            {vendor.offerText}
          </div>
        )}
        {vendor.isTopRated && (
